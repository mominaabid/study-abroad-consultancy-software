        ...
        <form onSubmit={handleSubmit} className="modal-form">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, preferred_country: e.target.value }))
                }
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, study_level: e.target.value }))
                }
              >
                <option value="">Select level</option>
                {["Bachelor", "Master", "PhD", "Diploma", "Short Course"].map(
                  (l) => (
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, counsellor_id: e.target.value }))
              }
            >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              <p className="drawer-sub">
                {lead.study_level} · {lead.preferred_country}
              </p>
            </div>
          </div>
          <button className="modal-close" onClick={onClose}>
      ...
      <div className="leads-header">
        ...
        <div className="leads-header-actions">
          ...
          <div className="view-toggle">
            ...
            <button
              className={view === "table" ? "view-btn active" : "view-btn"}
                  ...
                  >
                    ...
                    <td>
                      <div className="table-lead-info">
                        ...
                        <div>
                          ...
                          <p className="table-lead-country">
                            {lead.preferred_country || "—"}
                          </p>
                        </div>
                      </div>
                    ...
                    <td onClick={(e) => e.stopPropagation()}>
                      ...
                      >
                        ...
                        {!counsellors.find(
                          (c) => c.id === lead.counsellor_id,
                        ) &&
                          lead.counsellor && (
                            <option value={lead.counsellor_id}>
      ...
      {actionMenu && (
        ...
        >
          ...
          <button
            className="menu-danger"
            onClick={() => {
              setDeleteConfirm(actionMenu.lead);
              setActionMenu(null);
            }}
          >
            <svg
