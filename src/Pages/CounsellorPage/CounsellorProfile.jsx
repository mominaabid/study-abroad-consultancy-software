...
// Helper component for displaying each info card (same as AdminProfile)
...
// Edit Profile Modal – contains all editable counsellor fields
// Edit Profile Modal – contains all editable counsellor fields, with two-column layout
    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex justify-center items-center z-[100] p-4">
      <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSave} className="p-6 pt-4">
          {/* Two-column grid for editable fields */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            {/* Empty placeholder to keep grid alignment (optional) */}
            <div></div>
          </div>
          ...
          <div className="mt-4">
            ...
            <div className="flex items-start gap-2 px-4 py-2.5 border border-gray-200 rounded-xl focus-within:ring-2 focus-within:ring-teal-200 focus-within:border-teal-400 transition">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="3"
                className="flex-1 outline-none bg-transparent text-gray-800 placeholder-gray-400 resize-none"
