    ...
    <div className="fixed inset-0 z-[1500] flex items-center justify-center bg-black/50">
      ...
      <div className="bg-white w-full max-w-2xl rounded-2xl overflow-hidden">
              ...
              {logsLoading ? (
                ...
                logs.map((log) => (
                  <div key={log.id} className="flex gap-3 mb-3">
                    ...
                    <div className={`w-10 h-10 flex items-center justify-center text-white rounded-full ${LOG_COLORS[log.action_type] || "bg-gray-400"}`}>
        ...
        <div className="p-4 border-t text-right">
          <button onClick={onClose} className="bg-gray-700 text-white px-4 py-2 rounded">
            Close
          </button>
        </div>
